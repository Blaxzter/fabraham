    ...
    >
        ...
        <div class="space-y-2">
            ...
            <div v-if="!store.collapsedSections.camera" class="space-y-2 pl-2">
                ...
                <div
                    v-if="store.cameraControlMode === 'scroll'"
                    class="space-y-1"
                >
            ...
            >
                <div class="flex items-center space-x-2">
                    <input
                        ...
                        class="w-4 h-4"
                    />
                    <label for="wireframe" class="text-sm"
                        >Show Wireframe</label
                    >
                </div>
                <div class="flex items-center space-x-2">
                    <input
                        ...
                        class="w-4 h-4"
                    />
                    <label for="rotationAxis" class="text-sm"
        ...
        <div class="space-y-2">
            ...
            >
                ...
                <ChevronDownIcon
                    v-if="!store.collapsedSections.lights"
                    class="w-4 h-4 text-gray-400"
                />
                <ChevronRightIcon v-else class="w-4 h-4 text-gray-400" />
            </button>
            ...
            >
                ...
                <div class="flex items-center space-x-2">
                    <input
                        ...
                        class="w-4 h-4"
                    />
                    <label for="lightHelpers" class="text-sm"
                        >Show Light Helpers</label
                    >
                </div>
                    ...
                    <div class="space-y-1">
                        <div class="flex items-center space-x-2">
                            <input
                                ...
                                class="w-4 h-4"
                            />
                            <label for="redLight" class="text-sm"
                                >Red Light</label
                            >
                        </div>
                        <div
                        ...
                        >
                            <label class="text-xs text-gray-400">
                                Intensity:
                                {{ store.redLight.intensity.toFixed(1) }}
                            </label>
                            <input
                    ...
                    <div class="space-y-1">
                        <div class="flex items-center space-x-2">
                            <input
                                ...
                                class="w-4 h-4"
                            />
                            <label for="greenLight" class="text-sm"
                                >Green Light</label
                            >
                        </div>
                        <div
                        ...
                        >
                            <label class="text-xs text-gray-400">
                                Intensity:
                                {{ store.greenLight.intensity.toFixed(1) }}
                            </label>
                            <input
                    ...
                    <div class="space-y-1">
                        <div class="flex items-center space-x-2">
                            <input
                                ...
                                class="w-4 h-4"
                            />
                            <label for="blueLight" class="text-sm"
                                >Blue Light</label
                            >
                        </div>
                        <div
                        ...
                        >
                            <label class="text-xs text-gray-400">
                                Intensity:
                                {{ store.blueLight.intensity.toFixed(1) }}
                            </label>
                            <input
                    ...
                    <div class="space-y-1">
                        <div class="flex items-center space-x-2">
                            <input
                                ...
                                class="w-4 h-4"
                            />
                            <label for="yellowLight" class="text-sm"
                                >Yellow Light</label
                            >
                        </div>
                        <div
                        ...
                        >
                            <label class="text-xs text-gray-400">
                                Intensity:
                                {{ store.yellowLight.intensity.toFixed(1) }}
                            </label>
                            <input
                    ...
                    <div class="space-y-1">
                        <div class="flex items-center space-x-2">
                            <input
                                ...
                                class="w-4 h-4"
                            />
                            <label for="purpleLight" class="text-sm"
                                >Purple Light</label
                            >
                        </div>
                        <div
                        ...
                        >
                            <label class="text-xs text-gray-400">
                                Intensity:
                                {{ store.purpleLight.intensity.toFixed(1) }}
                            </label>
                            <input
                    ...
                    <div class="space-y-1">
                        <div class="flex items-center space-x-2">
                            <input
                                ...
                                class="w-4 h-4"
                            />
                            <label for="spotlight" class="text-sm"
                                >Spotlight</label
                            >
                        </div>
                        <div
                        ...
                        >
                            <label class="text-xs text-gray-400">
                                Intensity:
                                {{ store.spotlight.intensity.toFixed(1) }}
                            </label>
                            <input
                ...
                <div v-if="store.enableASCII" class="space-y-3">
                    ...
                    <div class="flex items-center space-x-2">
                        <input
                            ...
                            class="w-4 h-4"
                        />
                        <label for="useSceneColor" class="text-sm"
                            >Use Scene Color</label
                        >
                    </div>
