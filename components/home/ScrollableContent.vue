...
<template>
    ...
    <div class="h-[500vh] relative" style="touch-action: pan-y">
        <!-- Invisible content to make div touchable on mobile -->
  ...
  >
    ...
    <!-- Scroll Indicator -->
    <ScrollIndicator :scroll-progress="scrollProgress" :fade-out-threshold="0.05" />
</template>
